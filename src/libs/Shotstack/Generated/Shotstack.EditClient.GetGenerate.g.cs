...
namespace Shotstack
{
    public partial class EditClient
    {
        ...
        private static readonly global::Shotstack.EndPointSecurityRequirement s_GetGenerateSecurityRequirement0 =
        ...
        private static readonly global::Shotstack.EndPointSecurityRequirement[] s_GetGenerateSecurityRequirements =
            new global::Shotstack.EndPointSecurityRequirement[]
            {                s_GetGenerateSecurityRequirement0,
            };
        partial void PrepareGetGenerateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetGenerateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetGenerateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetGenerateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Shotstack.GenerationResponse> GetGenerateAsync(
            string id,
            global::Shotstack.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetGenerateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Shotstack.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Shotstack.AutoSDKHttpResponse<global::Shotstack.GenerationResponse>> GetGenerateAsResponseAsync(
            string id,
            global::Shotstack.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Shotstack.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetGenerateSecurityRequirements,
                operationName: "GetGenerateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Shotstack.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Shotstack.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetGenerateAsync",
                                pathTemplate: "$\"/edit/v1/generate/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Shotstack.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetGenerateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Shotstack.GenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Shotstack.AutoSDKHttpResponse<global::Shotstack.GenerationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Shotstack.GenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
