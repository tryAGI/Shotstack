...
namespace Shotstack
{
    public partial class EditClient
    {
        ...
        private static readonly global::Shotstack.EndPointSecurityRequirement s_PostGenerateSecurityRequirement0 =
        ...
        private static readonly global::Shotstack.EndPointSecurityRequirement[] s_PostGenerateSecurityRequirements =
            new global::Shotstack.EndPointSecurityRequirement[]
            {                s_PostGenerateSecurityRequirement0,
            };
        ...
        partial void ProcessPostGenerateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Shotstack.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateSecurityRequirements,
                operationName: "PostGenerateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Shotstack.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Shotstack.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostGenerateAsync",
                                pathTemplate: "\"/edit/v1/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Shotstack.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
