...
namespace Shotstack
{
    public partial interface IIngestClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Shotstack.UploadResponse> GetUploadSignedUrlAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Shotstack.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Shotstack.AutoSDKHttpResponse<global::Shotstack.UploadResponse>> GetUploadSignedUrlAsResponseAsync(
            global::Shotstack.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}