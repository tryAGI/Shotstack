...
namespace Shotstack
{
    public partial interface IEditClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Shotstack.TemplateResponse> PutTemplateAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Shotstack.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Shotstack.AutoSDKHttpResponse<global::Shotstack.TemplateResponse>> PutTemplateAsResponseAsync(
            string id,
