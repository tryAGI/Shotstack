...
namespace Shotstack
{
    public partial class IngestClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Shotstack.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Shotstack.AutoSDKHttpResponse<global::Shotstack.QueuedSourceResponse>> PostSourceAsResponseAsync(
                ...
                else
                {
                    await global::Shotstack.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Shotstack.ApiException<global::Shotstack.IngestErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Shotstack.QueuedSourceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Shotstack.AutoSDKHttpResponse<global::Shotstack.QueuedSourceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Shotstack.QueuedSourceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
