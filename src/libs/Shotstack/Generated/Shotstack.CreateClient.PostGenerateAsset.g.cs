    ...
    public partial class CreateClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::Shotstack.GeneratedAssetErrorResponse? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::Shotstack.GeneratedAssetErrorResponse.FromJson(__content_400, JsonSerializerContext);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Shotstack.ApiException<global::Shotstack.GeneratedAssetErrorResponse>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Shotstack.GeneratedAssetResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Shotstack.GeneratedAssetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
